...
const About = () => {
  return (
    <section id="about" className="bg-gray-700 flex justify-center items-center gap-6 w-full mt-10">
        ...
        <div className="text-white flex flex-col text-center gap-3 w-1/3 mr-10 md:m-0">
            ...
            <p className="lg:text-2xl">Welcome to Hell Kitchen, your spot for handcrafted burgers, stone-baked pizzas, and fresh pasta.
